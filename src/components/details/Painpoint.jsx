        ...
        <h1 className="text-xl font-medium">Pain Points</h1>
            <ul>
                ...
                {persona.painPointsAndChallenges.biggestProblems.map((problem, index)=>(
                    <p key={index}>{index+1}. {problem}</p>
                ))}
            </ul>

            <ul>
                <p className='font-medium'>📌 Frustrations</p>
                {persona.painPointsAndChallenges.frustration.map((point, index)=>(
                    <p key={index}>{index+1}. {point}</p>
                ))}
            </ul>

            <ul>
                <p className='font-medium'>📌 Common Objections</p>
                {persona.painPointsAndChallenges.commonObjections.map((objection, index)=>(
                    <p key={index}>{index+1}. {objection}</p>
                ))}
            </ul>
        </Card>
    </div>
