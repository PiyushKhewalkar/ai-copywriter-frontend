  ...
  return (
          ...
          <Card className="rounded-sm w-full p-3">
            ...
            <div className="flex flex-wrap space-x-2 space-y-2 md:space-y-0">
                ...
                <span className="border-dashed border-[1px] border-slate-600 text-slate-200 rounded-sm p-2">{persona.ageRange} years old</span>
                <span className="border-dashed border-[1px] border-slate-600 text-slate-200 rounded-sm p-2">{persona.gender}</span>
                <span className="border-dashed border-[1px] border-slate-600 text-slate-200 rounded-sm p-2">Earns {persona.incomeLevel}</span>
                <span className="border-dashed border-[1px] border-slate-600 text-slate-200 rounded-sm p-2">{persona.maritalStatus}</span>
            </div>
          </Card>
  )
}
