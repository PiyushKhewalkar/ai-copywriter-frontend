    ...
    <div>
        ...
        <h1 className="text-xl font-medium">Goals & Vision</h1>
            ...
            <ul>
                ...
                {persona.goalsAndAspirations.secondaryGoals.map((goal, index)=>(
                    <p key={index}>{index+1}. {goal}</p>
                ))}
            </ul>
            <p><span className='font-medium'>📌 Long Term Vision:</span> {persona.goalsAndAspirations.longTermVision}</p>
        </Card>
    </div>
  )
}
